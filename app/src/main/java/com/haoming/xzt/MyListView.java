...
public class MyListView extends ListView implements OnScrollListener {
	 ...
	 * @param enable
	 */
	public void setPullLoadEnable(boolean enable, int num) {
		mEnablePullLoad = enable;
		if (!mEnablePullLoad) {

			if (num == 0) {
				//mFooterView.NoDateSetFooterView();
	...
	public void startRefresh() {
		if (mPullRefreshing == false) {
			...
			mHeaderView.setVisiableHeight(92);
	...
	public void setXListViewListener(IXListViewListener ls) {
		mListViewListener = ls;
	}
